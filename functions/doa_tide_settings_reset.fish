function doa_tide_settings_reset \
    --description "Reset Tide settings to DudeOfAwesome's preferences"
    ...
    set --universal prompt_add_newline_before true
    ...
    set --universal tide_gcloud_icon \ue7b2

    if "$enable_logging" != false
        echo "Set Tide settings to DudeOfAwesome's preferences."
    end
end
